...
export const PromoSection = () =>
    <VStack overflow={'hidden'} position='relative' w={'full'}>
        ...
        <Container mb='3rem' position='relative'>
            <Text>СтудАктив БИ - большая и дружная семья активных студентов образовательной программы “Бизнес-информатика”. Более 10 лет мы разбавляем учебу в университете нашими мероприятиями и дарим студентам незабываемые эмоции.</Text>
